    ...
    <footer className={globalStyles.footer}>
      <div className={globalStyles.footerContent}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '2rem', marginBottom: '3rem', width: '100%' }}>
          <Newsletter />
          <Link href="/contact" className={globalStyles.ctaButtonLight} onClick={() => trackCTAClick("start_project", "footer")}>
            Start a Project
          </Link>
        </div>
        ...
        <div className={globalStyles.footerContact}>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', margin: '1.5rem 0 0.5rem 0' }}>
