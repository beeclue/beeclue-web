        ...
        <div className={styles.aboutGrid} style={{ marginBottom: "5rem" }}>
          <div className={styles.aboutText}>
            ...
            <p style={{ marginTop: "1rem", padding: "0.75rem 1rem", border: "1px solid var(--border)", borderRadius: "12px", background: "rgba(51,133,255,0.08)" }}>
              <strong>FREE domain on plans above $29/mo:</strong> your professional domain is included free while you&apos;re with us — we handle the setup. <Link href="/free-domain-with-website" className={styles.learnMoreLink}>How free domain works <ArrowRight size={16} /></Link>
            </p>
          </div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
