...
export default function BlogPost() {
  const breadcrumbs = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Best School Website Design Companies Canada", "item": "https://beeclue.com/best-school-website-design-companies-canada" }
    ]
  };
    ...
    <main style={{ minHeight: "100vh", position: "relative" }}>
      <article className={blogStyles.blogContainer}>
        ...
        <FadeIn className={blogStyles.heroImageContainer}>
          <Image 
            src="https://images.unsplash.com/photo-1509062522246-3755977927d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75" 
            alt="University campus building representing school website design" 
            fill
