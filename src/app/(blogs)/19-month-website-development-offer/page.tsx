...
export default function BlogPost() {
  const breadcrumbs = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "19 Month Website Development Offer", "item": "https://beeclue.com/19-month-website-development-offer" }
    ]
  };
  ...
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Affordable Website Design – Only $19/Month | Beeclue",
    "description": "Get a professional website design, hosting, and maintenance for just $19/month. Perfect for small businesses.",
    "author": {
      "@type": "Organization",
