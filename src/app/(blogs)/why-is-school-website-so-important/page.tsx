...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75",
        width: 1200,
        height: 630,
...
export default function BlogPost() {
  const breadcrumbs = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Why Is School Website So Important", "item": "https://beeclue.com/why-is-school-website-so-important" }
    ]
  };
  ...
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Why is a School Website So Important? | Beeclue",
    "description": "Discover why a well-designed school website is essential for modern education. Learn how it improves communication, boosts enrollment, and streamlines administration.",
    "author": {
      "@type": "Organization",
    ...
    <main style={{ minHeight: "100vh", position: "relative" }}>
      <article className={blogStyles.blogContainer}>
        ...
        <FadeIn className={blogStyles.heroImageContainer}>
          <Image 
            src="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75" 
            alt="School Classroom with Students" 
            fill
        ...
        <div className={blogStyles.blogContent}>
          ...
          <FadeIn className={blogStyles.inlineImageContainer}>
            <Image 
              src="https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=75" 
